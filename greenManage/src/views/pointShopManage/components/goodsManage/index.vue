<template>
  ...
  <el-table :data="tableData" style="width: 100%; height: 555px;">
    ...
    <el-table-column prop="goodPoint" label="商品积分" />
  ...
  <el-dialog v-model="dialogVisible" title="商品信息修改" width="500">
    <el-form ref="ruleFormRef" style="max-width: 600px" :model="ruleForm" status-icon label-width="auto"
      class="demo-ruleForm">
      <el-form-item label="商品id" prop="productId">
        <el-input v-model="ruleForm.productId" type="text" autocomplete="off" disabled />
      </el-form-item>
...
import { insert, deleteOne, update, selectAll, selectOne, selectByPage } from '../../../../api/prod';
...
const deleteInfo = (index: number) => {
  deleteOne(tableData[index].productId)
